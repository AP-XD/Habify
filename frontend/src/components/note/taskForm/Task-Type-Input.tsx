        ...
        <div className="relative categories-form">
            ...
            >
                {[...defaultNoteTypes, ...currentCustomLabels].map((customLabel) => {
                    ...
                    return (
                        <li
                            className={`relative block whitespace-nowrap overflow-hidden text-ellipsis px-8 py-2 text-lg tracking-wide transition-all cursor-pointer ${label._id === customLabel._id ? '!bg-blue-500 font-semibold' : ''
                                } hover:bg-blue-700`}
