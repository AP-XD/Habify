...
const FilterOption = ({ option, filterData, filterDataSetters, setShowFullAddForm }: FilterOptionProps) => {
                    ...
                    <>
                        <div className="fl sm:mb-8 mb-6 justify-center sm:flex-row flex-col">
                            <TaskDate
                                ...
                                inputClassname="border-2 border-solid border-blue-100 px-2 rounded-md"
                                isStartDate={true}
                            />
                            <div ref={dateDashRef}>
    ...
    return (
        <div
            ...
            className={`filter-option min-w-[12rem] cursor-pointer relative flex-between mx-3 pl-4 pr-7 py-3 mt-2 flex-1 xs:basis-[15%] basis-full rounded-lg shadow-md text-blue-700 transition-all duration-[250ms] ${isModalOpened ? '!bg-blue-600 !text-white !shadow-lg focused' : ''
        ...
        >
            ...
            <span className={`text-2xl absolute right-2 top-4 text-blue-500 filter-arrow transition-all duration-[250ms] ${isModalOpened ? 'opened' : 'closed'}`}>
                <IoIosArrowDown />
            </span>
