    ...
    return (
        ...
        >
            <div className={`fl justify-between flex-wrap transition-all duration-300 ${isFilterBarShown ? 'delay-300' : 'opacity-0 invisible'}`}>
                ...
                <FilterSearchInput
                    inputClassName="filter-search-input rounded-lg py-3 h-full min-w-[12rem] pr-8  hover:text-white focus-within:text-white focus-within:bg-blue-600 hover:bg-blue-600 focus-within:placeholder:text-white hover:placeholder:text-white"
            ...
            <span
                ...
                className={`text-4xl absolute -bottom-7 text-blue-600 z-50 cursor-pointer transition-all duration-300 block right-4 ${isFilterBarShown ? 'rotate-180' : ''} hover:text-blue-700`}
            >
                <IoIosArrowDown />
            </span>
            <span
                onClick={resetFilters}
                className={`text-lg absolute -bottom-[22px] px-[6px] py-[1px] bg-blue-500 text-white rounded-lg z-50 cursor-pointer transition-all duration-300 block right-16  hover:bg-blue-600`}
            >
                Reset
            </span>
        </div>
