...
const FilterModalOption = ({ text, onchange, checkedAtStart, showCheckmark = true, canToggle = true, forceCheck, refToClick }: FilterModalOptionProps) => {
    ...
    return (
        <label
            ...
            className={`block sm:text-xl text-lg filter-modal-option relative px-10 sm:py-2 py-1 border-solid border-2 w-full border-blue-100 rounded-md sm:mb-3 mb-2 cursor-pointer transition-all ${checked ? 'bg-blue-600 border-blue-600 text-white' : ''
                } hover:bg-blue-500 hover:text-white duration-300 hover:shadow-md hover:border-blue-500`}
        >
            <input
